...
public class UserStatsService {
    ...
    public UserStatsService(MatchRepository matchRepository, MatchParticipantRepository matchPlayerRepository, PlayerRatingRepository ratingRepository, PlayerCardStatsRepository cardRepository, PlayerCardStatsHistoryRepository cardHistoryRepository, TournamentMatchParticipantRepository tournamentMatchParticipantRepository) {
    ...
    public UserStatsDto getUserStats(UUID userId) {
        int matchesPlayed = matchPlayerRepository.countByUser_Id(userId) + tournamentMatchParticipantRepository.countTournamentMatchesForUser(userId, MatchStatus.DONE);
